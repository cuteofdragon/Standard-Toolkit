...
namespace ComponentFactory.Krypton.Ribbon
{
                                           ...
                                           IRibbonKeyTipTarget
    {
        ...
        {
            if ((_richTextBox.LastRichTextBox?.RichTextBox != null) && (_richTextBox.LastRichTextBox.RichTextBox.CanFocus))
            {
        ...
        public void KeyTipSelect(KryptonRibbon ribbon)
        {
            ...
            if (_richTextBox.LastRichTextBox.CanFocus)
            {
                ...
                if (_richTextBox.LastParentControl is VisualPopupGroup popupGroup)
                {
