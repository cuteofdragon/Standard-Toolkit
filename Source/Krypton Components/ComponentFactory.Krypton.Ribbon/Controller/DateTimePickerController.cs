                                              ...
                                              IRibbonKeyTipTarget
    {
        ...
        public void KeyTipSelect(KryptonRibbon ribbon)
        {
            ...
            if (_dateTimePicker.LastDateTimePicker.CanFocus)
            {
                ...
                // has been placed on the date time picker and so focus is allowed to change
                ...
                // If the date time picker is inside a popup window
                if (_dateTimePicker.LastParentControl is VisualPopupGroup popupGroup)
                {
