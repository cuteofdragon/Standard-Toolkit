...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    /// </summary>
    internal class ViewDrawRibbonGroupButtonText : ViewLeaf,
                                                   IContentValues
    {
        ...
        public override string ToString()
        {
            ...
            return "ViewDrawRibbonGroupButtonText:" + Id;
        }
        ...
        public override void Layout(ViewLayoutContext context)
        {
                ...
                (_ribbon.DirtyPaletteCounter != _dirtyPaletteLayout))
            {
                ...
                // Reverse the GetPreferredSize action of reducing size by 1 to make text display tighter
                drawRect.Width += 1;
