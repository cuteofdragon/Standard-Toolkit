...
// 
//  Modifications by MegaKraken, Thavarajan, Peter Wagner(aka Wagnerp) & Simon Coghlan(aka Smurf-IV) 2017 - 2020. All rights reserved. (https://github.com/Krypton-Suite/Standard-Toolkit)
...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public abstract class PaletteOffice365Base : PaletteBase
    {
        ...
        #region Constructor        
        /// <summary>
        /// Initializes a new instance of the <see cref="PaletteOffice365Base"/> class.
        /// </summary>
        ...
        public PaletteOffice365Base(Color[] schemeColours, ImageList checkBoxList, ImageList galleryButtonList, Image[] radioButtonArray, Color[] trackBarColours)
        {
        ...
        {
            return KryptonManager.RenderOffice365;
        }
        #endregion
            ...
            switch (style)
            {
                ...
                case PaletteBackStyle.GridHeaderRowCustom3:
                    switch (state)
                    {
                        ...
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.GridListNormal1];
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.GridListPressed1];
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridListSelected];
                    }
                case PaletteBackStyle.GridHeaderColumnSheet:
                    switch (state)
                    {
                        ...
                        default:
                        case PaletteState.Normal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetColNormal1];
                        case PaletteState.Tracking:
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetColPressed1];
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetColSelected1];
                    }
                case PaletteBackStyle.GridHeaderRowSheet:
                    switch (state)
                    {
                        ...
                        default:
                        case PaletteState.Normal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetRowNormal];
                        case PaletteState.Tracking:
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetRowPressed];
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetRowSelected];
                    }
                case PaletteBackStyle.GridDataCellList:
                case PaletteBackStyle.GridDataCellCustom1:
                case PaletteBackStyle.GridDataCellCustom2:
                ...
                case PaletteBackStyle.ButtonForm:
                    switch (state)
                    {
                        ...
                        case PaletteState.NormalDefaultOverride:
                            return Color.Empty;
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack1Checked];
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack1Track];
                        case PaletteState.CheckedTracking:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack1CheckTrack];
                        case PaletteState.Pressed:
                        case PaletteState.CheckedPressed:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack1Pressed];
                        default:
                            throw new ArgumentOutOfRangeException(nameof(state));
                    }
                case PaletteBackStyle.ButtonFormClose:
                ...
                case PaletteBackStyle.ButtonNavigatorMini:
                    switch (state)
                    {
                        ...
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorTrack1];
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorPressed1];
                        case PaletteState.CheckedNormal:
                        case PaletteState.CheckedTracking:
                        case PaletteState.CheckedPressed:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorChecked1];
                        default:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNormalNavigatorBack1];
                    }
                default:
                    throw new ArgumentOutOfRangeException(nameof(style));
            }
            ...
            switch (style)
            {
                ...
                case PaletteBackStyle.GridHeaderRowCustom3:
                    switch (state)
                    {
                        ...
                        case PaletteState.Normal:
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.GridListNormal2];
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.GridListPressed2];
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridListSelected];
                    }
                case PaletteBackStyle.GridHeaderColumnSheet:
                    switch (state)
                    {
                        ...
                        default:
                        case PaletteState.Normal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetColNormal2];
                        case PaletteState.Tracking:
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetColPressed2];
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.GridSheetColSelected2];
                    }
                case PaletteBackStyle.GridHeaderRowSheet:
                    switch (state)
                    {
                ...
                case PaletteBackStyle.ButtonForm:
                    switch (state)
                    {
                        ...
                        case PaletteState.NormalDefaultOverride:
                            return Color.Empty;
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack2Checked];
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack2Track];
                        case PaletteState.CheckedTracking:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack2CheckTrack];
                        case PaletteState.Pressed:
                        case PaletteState.CheckedPressed:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBack2Pressed];
                        default:
                            throw new ArgumentOutOfRangeException(nameof(state));
                    }
                case PaletteBackStyle.ButtonFormClose:
                ...
                case PaletteBackStyle.ButtonNavigatorMini:
                    switch (state)
                    {
                        case PaletteState.Disabled:
                            return _buttonBackColors[1];
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorTrack2];
                        case PaletteState.Pressed:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorPressed2];
                        case PaletteState.CheckedNormal:
                        case PaletteState.CheckedTracking:
                        case PaletteState.CheckedPressed:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorChecked2];
                        default:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNormalNavigatorBack2];
                    }
                default:
                    throw new ArgumentOutOfRangeException(nameof(style));
            }
        ...
        public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state)
        {
            ...
            switch (style)
            {
                ...
                case PaletteBorderStyle.ButtonForm:
                    switch (state)
                    {
                        ...
                        case PaletteState.NormalDefaultOverride:
                            return Color.Empty;
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBorderCheck];
                        case PaletteState.Tracking:
                        case PaletteState.CheckedTracking:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBorderTrack];
                        case PaletteState.Pressed:
                        case PaletteState.CheckedPressed:
                            return _ribbonColours[(int)SchemeOfficeColors.FormButtonBorderPressed];
                        default:
                            throw new ArgumentOutOfRangeException(nameof(state));
                    }
                case PaletteBorderStyle.ButtonFormClose:
                ...
                case PaletteBorderStyle.ButtonNavigatorOverflow:
                case PaletteBorderStyle.ButtonNavigatorMini:
                    return _ribbonColours[(int)SchemeOfficeColors.ButtonNavigatorBorder];
                default:
                    throw new ArgumentOutOfRangeException(nameof(style));
            }
        }
        ...
        public override Color GetContentShortTextColor1(PaletteContentStyle style, PaletteState state)
        {
            ...
            if (CommonHelper.IsOverrideState(state))
            {
                switch (style)
                {
                    ...
                    case PaletteContentStyle.LabelTitleControl:
                        switch (state)
                        {
                            case PaletteState.LinkNotVisitedOverride:
                                return _ribbonColours[(int)SchemeOfficeColors.LinkNotVisitedOverrideControl];
                            case PaletteState.LinkVisitedOverride:
                                return _ribbonColours[(int)SchemeOfficeColors.LinkVisitedOverrideControl];
                            case PaletteState.LinkPressedOverride:
                                return _ribbonColours[(int)SchemeOfficeColors.LinkPressedOverrideControl];
                            default:
                    ...
                    case PaletteContentStyle.LabelGroupBoxCaption:
                        ...
                        {
                            case PaletteState.LinkNotVisitedOverride:
                                return _ribbonColours[(int)SchemeOfficeColors.LinkNotVisitedOverridePanel];
                            case PaletteState.LinkVisitedOverride:
                                return _ribbonColours[(int)SchemeOfficeColors.LinkVisitedOverridePanel];
                            case PaletteState.LinkPressedOverride:
                                return _ribbonColours[(int)SchemeOfficeColors.LinkPressedOverridePanel];
                            default:
                                // All other override states do nothing
                                return Color.Empty;
                        }
            ...
            switch (style)
            {
                ...
                case PaletteContentStyle.HeaderCustom2:
                case PaletteContentStyle.HeaderCustom3:
                    return _ribbonColours[(int)SchemeOfficeColors.HeaderText];
                case PaletteContentStyle.HeaderDockActive:
                    return Color.Black;
                case PaletteContentStyle.InputControlStandalone:
                case PaletteContentStyle.InputControlRibbon:
                ...
                case PaletteContentStyle.LabelKeyTip:
                    return _toolTipText;
                case PaletteContentStyle.ContextMenuHeading:
                    return _ribbonColours[(int)SchemeOfficeColors.ContextMenuHeadingText];
                case PaletteContentStyle.TabHighProfile:
                case PaletteContentStyle.TabStandardProfile:
                case PaletteContentStyle.TabLowProfile:
                case PaletteContentStyle.TabOneNote:
                ...
                case PaletteContentStyle.ButtonFormClose:
                    switch (state)
                    {
                        case PaletteState.Tracking:
                        case PaletteState.CheckedTracking:
                            return _ribbonColours[(int)SchemeOfficeColors.TextButtonFormTracking];
                        case PaletteState.Pressed:
                        case PaletteState.CheckedPressed:
                        case PaletteState.CheckedNormal:
                            return _ribbonColours[(int)SchemeOfficeColors.TextButtonFormPressed];
                        default:
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonDropArrowLight];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonDropArrowDark];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonGroupDialogDark];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonGroupDialogLight];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonGroupSeparatorDark];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonGroupSeparatorLight];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonMinimizeBarDark];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonMinimizeBarLight];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonTabSeparatorColor];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonQATButtonDark];
        }
        ...
        {
            return _ribbonColours[(int)SchemeOfficeColors.RibbonQATButtonLight];
        }
        #endregion
            ...
            switch (style)
            {
                case PaletteRibbonBackStyle.RibbonGalleryBack:
                    switch (state)
                    {
                        case PaletteState.Disabled:
                            return _disabledBack;
                        case PaletteState.Tracking:
                            return _ribbonColours[(int)SchemeOfficeColors.RibbonGalleryBackTracking];
                        case PaletteState.Normal:
                        default:
                            return _ribbonColours[(int)SchemeOfficeColors.RibbonGalleryBackNormal];
                    }
                case PaletteRibbonBackStyle.RibbonGalleryBorder:
                    switch (state)
                    {
                        ...
                        case PaletteState.Tracking:
                        default:
                            return _ribbonColours[(int)SchemeOfficeColors.RibbonGalleryBorder];
                    }
                case PaletteRibbonBackStyle.RibbonAppMenuDocs:
            ...
            switch (style)
            {
                ...
                case PaletteRibbonTextStyle.RibbonGroupNormalTitle:
                    switch (state)
                    {
                        case PaletteState.Disabled:
                            return _disabledText;
                        default:
                            return _ribbonColours[(int)SchemeOfficeColors.RibbonGroupTitleText];
                    }
                case PaletteRibbonTextStyle.RibbonTab:
                    switch (state)
                    {
                        ...
                        case PaletteState.ContextCheckedTracking:
                        case PaletteState.FocusOverride:
                            return _ribbonColours[(int)SchemeOfficeColors.RibbonTabTextChecked];
                        default:
                            return _ribbonColours[(int)SchemeOfficeColors.RibbonTabTextNormal];
                    }
        ...
        public override Color GetElementColor2(PaletteElement element, PaletteState state)
        {
            ...
            switch (element)
            {
                ...
                case PaletteElement.TrackBarPosition:
                    ...
                    {
                        case PaletteState.Disabled:
                            return ControlPaint.Light(_ribbonColours[(int)SchemeOfficeColors.ButtonNormalBorder]);
                        case PaletteState.Normal:
                            return _ribbonColours[(int)SchemeOfficeColors.ButtonNormalBorder];
                        case PaletteState.Tracking:
                        case PaletteState.FocusOverride:
        ...
        public override Color GetElementColor3(PaletteElement element, PaletteState state)
        {
            ...
            switch (element)
            {
                ...
                case PaletteElement.TrackBarPosition:
                    ...
                    {
                        case PaletteState.Disabled:
                            return ControlPaint.LightLight(_ribbonColours[(int)SchemeOfficeColors.ButtonNormalBack1]);
                        case PaletteState.Normal:
                            return ControlPaint.Light(_ribbonColours[(int)SchemeOfficeColors.ButtonNormalBack1]);
                        case PaletteState.Tracking:
